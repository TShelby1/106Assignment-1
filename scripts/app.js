...
function findOldest(list){
    ...
    for(i=0; i<list.length; i++){ //traveling the array
    let num = list[i]; //getting value from array and putting in variable
    if (num>solution){ // if any num is less than the starting point for solution, update that solution
        solution=num;
    }
    }
...
//exercise: 
    ...
    let ages= [12,43,45,34,34,34,23,23,56,67,78,89,89,33,22,33,44];
    sumAll(ages); 
